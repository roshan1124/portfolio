        ...
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <time class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
              Completed on Oct 9th, 2024
            </time>
            <p class="mb-4 text-base font-normal  text-gray-400">
              Provides a foundational understanding of Generative AI on Oracle Cloud Infrastructure (OCI), covering model deployment, prompt design, OCI AI services, and integration into applications.
            </p>
            <a
              href="https://drive.google.com/file/d/1p-HPSg4xG7PGC0IhR1wJPrRNbIDuw8pl/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            <time class="block mb-2 text-sm font-normal leading-none text-gray-500">
              Completed on Oct 19th, 2024
            </time>
            <p class="text-base font-normal text-gray-400">
Covers core concepts of artificial intelligence in the context of Salesforce, including responsible AI, ethical use, and how Salesforce embeds AI across its products to drive smarter business decisions.
            </p>
            <a
              href="https://drive.google.com/file/d/1W0r1qw2Xbs0gBneSaRN6v85EFwWiean7/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
          ...
          <li data-aos="zoom-in" data-aos-offset={"-15"} data-aos-delay="1300">
            ...
            <h3 class="mb-1 text-lg font-semibold text-white">
              AI & Cloud Internship - (IBM SkillsBuild Platform)
            </h3>
            <time class="block mb-2 text-sm font-normal leading-none text-gray-500">
              Completed from July 08, 2024 to August 05, 2024.
            </time>
            <p class="text-base font-normal text-gray-400">
Completed a 4-week virtual internship from July 08 to August 05, 2024, focused on Emerging Technologies including Artificial Intelligence and Cloud Computing. The program was conducted by Edunet Foundation in collaboration with AICTE, leveraging the IBM SkillsBuild and IBM Cloud Platform. Gained hands-on experience in cloud-based AI tools, foundational concepts in emerging tech, and career-focused skill-building.
            </p>
            <a
              target="_blank"
              rel="noreferrer"
              href="https://drive.google.com/file/d/1Z7OFXok-2pWgrlDYumgM-MrhvmIP4Bmg/view?usp=sharing"
              class="inline-flex items-center px-4 py-2 mt-5 text-sm font-medium border rounded-lg focus:z-10 focus:ring-4 focus:outline-none focus:text-blue-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 focus:ring-gray-700"
            >
              <svg
                class="w-4 h-4 mr-2"
